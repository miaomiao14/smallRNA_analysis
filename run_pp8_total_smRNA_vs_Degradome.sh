...
then
	...
	do
		...
		do
			OUTDIR=${OUT0}/${g}_${f}
			cut -f1,2 ${OUTDIR}/${g}_SRA_trransposon.${g}_SRA_trransposon.pp|awk -v gt=$g 'BEGIN{OFS="\t"}{print gt,$1,$2}' >> ${masterOUT}/SRA_trransposon.SRA_trransposon.nonnormalized.pp8score.txt
			cut -f1,2 ${OUTDIR}/${g}_SRA_trransposon.${g}_DEG_${f}.pp |awk -v gt=$g 'BEGIN{OFS="\t"}{print gt,$1,$2}'>> ${masterOUT}/SRA_trransposon.DEG_${f}.nonnormalized.pp8score.txt
			cut -f1,2 ${OUTDIR}/${g}_DEG_${f}.${g}_SRA_trransposon.pp |awk -v gt=$g 'BEGIN{OFS="\t"}{print gt,$1,$2}'>> ${masterOUT}/DEG_${f}.SRA_trransposon.nonnormalized.pp8score.txt
			...
			cut -f1,3 ${OUTDIR}/${g}_SRA_trransposon.${g}_SRA_trransposon.pp|awk -v gt=$g 'BEGIN{OFS="\t"}{print gt,$1,$2}' >> ${masterOUT}/SRA_trransposon.SRA_trransposon.normalized.pp8score.txt
			cut -f1,3 ${OUTDIR}/${g}_SRA_trransposon.${g}_DEG_${f}.pp |awk -v gt=$g 'BEGIN{OFS="\t"}{print gt,$1,$2}'>> ${masterOUT}/SRA_trransposon.DEG_${f}.normalized.pp8score.txt
			cut -f1,3 ${OUTDIR}/${g}_DEG_${f}.${g}_SRA_trransposon.pp |awk -v gt=$g 'BEGIN{OFS="\t"}{print gt,$1,$2}'>> ${masterOUT}/DEG_${f}.SRA_trransposon.normalized.pp8score.txt
			cut -f1,3 ${OUTDIR}/${g}_DEG_${f}.${g}_DEG_${f}.pp |awk -v gt=$g 'BEGIN{OFS="\t"}{print gt,$1,$2}'>> ${masterOUT}/DEG_${f}.DEG_${f}.normalized.pp8score.txt
	
		done
		
	
	${PIPELINE_DIRECTORY}/RRR ${PIPELINE_DIRECTORY}/R.source cast_master_table ${masterOUT}/SRA_trransposon.SRA_trransposon.nonnormalized.pp8score.txt ${masterOUT}/SRA_trransposon.SRA_trransposon.nonnormalized.pp8score.mastertable.txt
	${PIPELINE_DIRECTORY}/RRR ${PIPELINE_DIRECTORY}/R.source cast_master_table ${masterOUT}/SRA_trransposon.DEG_${f}.nonnormalized.pp8score.txt ${masterOUT}/SRA_trransposon.DEG_${f}.nonnormalized.pp8score.mastertable.txt
	${PIPELINE_DIRECTORY}/RRR ${PIPELINE_DIRECTORY}/R.source cast_master_table ${masterOUT}/DEG_${f}.SRA_trransposon.nonnormalized.pp8score.txt ${masterOUT}/DEG_${f}.SRA_trransposon.nonnormalized.pp8score.mastertable.txt
	...
	${PIPELINE_DIRECTORY}/RRR ${PIPELINE_DIRECTORY}/R.source cast_master_table ${masterOUT}/SRA_trransposon.SRA_trransposon.normalized.pp8score.txt ${masterOUT}/SRA_trransposon.SRA_trransposon.normalized.pp8score.mastertable.txt
	${PIPELINE_DIRECTORY}/RRR ${PIPELINE_DIRECTORY}/R.source cast_master_table ${masterOUT}/SRA_trransposon.DEG_${f}.normalized.pp8score.txt ${masterOUT}/SRA_trransposon.DEG_${f}.normalized.pp8score.mastertable.txt
	${PIPELINE_DIRECTORY}/RRR ${PIPELINE_DIRECTORY}/R.source cast_master_table ${masterOUT}/DEG_${f}.SRA_trransposon.normalized.pp8score.txt ${masterOUT}/DEG_${f}.SRA_trransposon.normalized.pp8score.mastertable.txt
