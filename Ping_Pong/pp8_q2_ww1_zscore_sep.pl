...
open O, ">$file1.$file2.1.zscore.out";
open OUA, ">$file1.$file2.1.UA_VA.zscore.out";
 
open OUT, ">$file1.$file2.1.pp";
open OUT0, ">$file1.$file2.1.VA.pp";
open OUT2, ">$file1.$file2.1.ppseq";

open OUT1,">$file1.$file2.1.pp_fraction";
...
# file1 as ref
 ` bowtie $file1.$n -r -a -v 1 -p 8 $file2.seq --suppress 1,4,6,7 | grep + > $file1.$file2.$n.bowtie.out`;
   ...
   open OUT3, ">$file1.$file2.1.pp_reads_percentage";
   ...
   open O, ">$file2.$file1.2.zscore.out";
   open OUA, ">$file2.$file1.2.UA_VA.zscore.out";
   
   open OUT, ">$file2.$file1.2.pp";
   open OUT0, ">$file2.$file1.2.VA.pp";
   open OUT2, ">$file2.$file1.2.ppseq";
...
# `rm $file2.$file1.$n.bowtie.out`;
   ...
   open OUT3, ">$file2.$file1.2.pp_reads_percentage";
