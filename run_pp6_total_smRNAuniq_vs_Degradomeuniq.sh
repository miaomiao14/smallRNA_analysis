...
do
	...
	demapper2=${degraINDIR}/Phil.DEG.${g}.ovary/bedIntersectWW/Phil.DEG.${g}.ovary.x_rRNA.dm3.sorted.f0x40.noS.5p.uniq.bed.ntm.collapse.xkxh.FLY_TRANSPOSON_ALL.nta.mapper2.gz
	[ ! -f $demapper2 ] && \
		mv ${degraINDIR}/Phil.DEG.${g}.ovary/bedIntersectWW/Phil.DEG.${g}.ovary.x_rRNA.dm3.sorted.f0x40.noS.5p.uniq.bed.ntm.collapse.FLY_TRANSPOSON_ALL.nta.mapper2.gz $demapper2
	...
	#total Ping-Pong
	[ ! -s ${smRNAINDIR}/pp6_FB_smRNAuniq_vs_degradomeuniq_total_with_ppscore/${g}.total.pp6.out ] && submitsge 24 $g "$script ${smmapper2%.gz}.23-29.gz ${demapper2} 2 ${smRNAINDIR}/pp6_FB_smRNAuniq_vs_degradomeuniq_total_with_ppscore >${smRNAINDIR}/pp6_FB_smRNAuniq_vs_degradomeuniq_total_with_ppscore/${g}.uniqmap.total.pp6.out" 
