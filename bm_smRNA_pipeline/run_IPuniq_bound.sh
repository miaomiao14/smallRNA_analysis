...
do
	...
	do
	cd ${OUTPUTDIR}	
	echo -ne " A=Pillai.SRA.${PRO[0]}.${g}.${o}.BmN4cell.trimmed && " >>${parafile}
	echo -ne " B=Pillai.SRA.${PRO[1]}.${g}.${o}.BmN4cell.trimmed && " >>${parafile}
	echo -ne " ANEW=Pillai.SRA.${PRO[0]}uniq.${g}.${o}.BmN4cell.trimmed && " >>${parafile}
	echo -ne " BNEW=Pillai.SRA.${PRO[1]}uniq.${g}.${o}.BmN4cell.trimmed && " >>${parafile}
	...
	#echo -ne " A=Pillai.SRA.Ago3IP.${g}.${o}.BmN4cell.trimmed && " >>${parafile}
	#echo -ne " B=Pillai.SRA.SiwiIP.${g}.${o}.BmN4cell.trimmed && " >>${parafile}
