...
INPUTDIR=/home/wangw1/data/bmn4/BmN4/insertsfromyt
OUTPUTDIR=/home/wangw1/data/bmn4/BmN4/insertsfromyt/uniqBound
...
declare -a OX=("ox")
declare -a PRO=("FLAGBmAgo3IP" "FLAGSiwiIP")
...
do
	...
	do
	cd ${OUTPUTDIR}	
	echo -ne " A=Yuki.SRA.${PRO[0]}.${g}.${o}.BmN4cell.trimmed && " >>${parafile}
	echo -ne " B=Yuki.SRA.${PRO[1]}.${g}.${o}.BmN4cell.trimmed && " >>${parafile}
	echo -ne " ANEW=Yuki.SRA.${PRO[0]}uniq.${g}.${o}.BmN4cell.trimmed && " >>${parafile}
	echo -ne " BNEW=Yuki.SRA.${PRO[1]}uniq.${g}.${o}.BmN4cell.trimmed && " >>${parafile}
	...
	#echo -ne " A=Yuki.SRA.Ago3IP.${g}.${o}.BmN4cell.trimmed && " >>${parafile}
	#echo -ne " B=Yuki.SRA.SiwiIP.${g}.${o}.BmN4cell.trimmed && " >>${parafile}
