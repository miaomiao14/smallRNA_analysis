...
do 
	...
	cat ${gt}_uniq_unox_AubIPSRA_Ago3IPSRA_prefix16_v26/AubIPuniq_${gt}_unox_.Ago3IPuniq_${gt}_unox.16.prefix.UA_VA.ppseq.cis.guide ${gt}_uniq_unox_AubIPSRA_Ago3IPSRA_prefix16_v26/AubIPuniq_${gt}_unox_.Ago3IPuniq_${gt}_unox.16.prefix.UA_VA.ppseq.trans.guide |cut -f1 |sort -u >${gt}_uniq_unox_AubIPSRA_Ago3IPSRA_prefix16_v26/AubIPuniq_${gt}_unox_.Ago3IPuniq_${gt}_unox.16.prefix.UA_VA.ppseq.guide

	#cat cis and trans target: Aub:Ago3 PP
	cat ${gt}_uniq_unox_AubIPSRA_Ago3IPSRA_prefix16_v26/AubIPuniq_${gt}_unox_.Ago3IPuniq_${gt}_unox.16.prefix.UA_VA.ppseq.cis.target ${gt}_uniq_unox_AubIPSRA_Ago3IPSRA_prefix16_v26/AubIPuniq_${gt}_unox_.Ago3IPuniq_${gt}_unox.16.prefix.UA_VA.ppseq.trans.target |cut -f1 |sort -u >${gt}_uniq_unox_AubIPSRA_Ago3IPSRA_prefix16_v26/AubIPuniq_${gt}_unox_.Ago3IPuniq_${gt}_unox.16.prefix.UA_VA.ppseq.target
	...
	cat ${gt}_uniq_unox_AubIPSRA_Ago3IPSRA_prefix16_v26/Ago3IPuniq_${gt}_unox_.AubIPuniq_${gt}_unox.16.prefix.UA_VA.ppseq.cis.guide ${gt}_uniq_unox_AubIPSRA_Ago3IPSRA_prefix16_v26/Ago3IPuniq_${gt}_unox_.AubIPuniq_${gt}_unox.16.prefix.UA_VA.ppseq.trans.guide |cut -f1 |sort -u >${gt}_uniq_unox_AubIPSRA_Ago3IPSRA_prefix16_v26/Ago3IPuniq_${gt}_unox_.AubIPuniq_${gt}_unox.16.prefix.UA_VA.ppseq.guide

	#cat cis and trans target:Ago3:Aub PP
	cat ${gt}_uniq_unox_AubIPSRA_Ago3IPSRA_prefix16_v26/Ago3IPuniq_${gt}_unox_.AubIPuniq_${gt}_unox.16.prefix.UA_VA.ppseq.cis.target ${gt}_uniq_unox_AubIPSRA_Ago3IPSRA_prefix16_v26/Ago3IPuniq_${gt}_unox_.AubIPuniq_${gt}_unox.16.prefix.UA_VA.ppseq.trans.target |cut -f1 |sort -u >${gt}_uniq_unox_AubIPSRA_Ago3IPSRA_prefix16_v26/Ago3IPuniq_${gt}_unox_.AubIPuniq_${gt}_unox.16.prefix.UA_VA.ppseq.target
