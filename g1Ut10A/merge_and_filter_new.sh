...
It currently store the table for converting chi score to p value, 0.05, 0.005, .0005, 0.000001, 1e-10, 1e-20, 1e-40 are supported.
...
awk -v p=$P_VALUE -v fold_thres=$FOLD_THRES -f $RUN_DIRECTORY/filter_chi_new.awk ${PREFIX}.merged_insert.chi
