...
my $help="Help";
my $strandedness=1;
my $ok = GetOptions( 'help|?' => \$help,'inputFile1|i=s' => \$inFileName1, 'end1|e1=s' => \$end1, 'inputFile2|j=s' => \$inFileName2,'end2|e2=s' => \$end2, 'outputDir|o=s' => \$outDir, 'format|F=s' => \$format, 'Clone|C=s' => $CLONE, 'windowSize|w=i' => \$winSize, 'strandedness|s=i' => \$strandedness );
...
sub Usage
{
	...
	print " [-s <int>]\tsame strand or different strand[1|0]\n";
