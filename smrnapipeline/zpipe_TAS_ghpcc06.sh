...
`mkdir -p $dir/output`
ln -s $1 $dir/$insertsname.uniq.reads
inserts=$dir/$insertsname
#1. map to the virus
echo "mapping to the virus..." >> $dir/output/$insertsname.log
echo `date` >> $dir/output/$insertsname.log
run_bowtie.pl $inserts.uniq.reads $mm ${BOWTIEINDEXPATH}/dmel_virus virus
...
if [ "$mm" == '0' ];
then
run_bowtie.pl $inserts.uniq.reads 1 ${BOWTIEINDEXPATH}/dmel_TAS match2_all.out
run_bowtie_mismatchstats.pl $inserts.uniq.reads > $dir/output/$insertsname.mismatchstats.table
run_bowtie.pl $inserts.uniq.reads 0 ${BOWTIEINDEXPATH}/dmel_TAS match2_all.out
else
run_bowtie.pl $inserts.uniq.reads 1 ${BOWTIEINDEXPATH}/dmel_TAS match2_all.out
run_bowtie_mismatchstats.pl $inserts.uniq.reads > $dir/output/$insertsname.mismatchstats.table
fi
...
normbed2mapper /home/ww74w/smallRNApipeline/pipeline_dm/common/transposons+mst40+suffix+dodeca+stellate+TARTA+P.map $inserts.norm.bed map> $inserts.transposon.mapper
...
echo `date` >> $dir/output/$insertsname.log
maptocat $inserts.uniq.reads /home/ww74w/smallRNApipeline/pipeline_dm/common/knownRNAs.cat /home/ww74w/smallRNApipeline/pipeline_dm/common/knownRNAs.len $inserts.knownRNA.mapper
...
maptocat $inserts.uniq.reads /home/ww74w/smallRNApipeline/pipeline_dm/common/hairpin.cat /home/ww74w/smallRNApipeline/pipeline_dm/common/hairpin.len $inserts.hairpin_all.mapper
...
run_bowtie.pl $inserts.uniq.reads $mm ${BOWTIEINDEXPATH}/dmel_transcript mRNA
...
run_bowtie.pl $inserts.uniq.reads $mm ${BOWTIEINDEXPATH}/dmel_exon exon
bowtieout2mapper.pl $inserts.exon /home/ww74w/smallRNApipeline/pipeline_dm/common/exon.map > $inserts.exon.mapper
...
run_bowtie.pl $inserts.uniq.reads $mm ${BOWTIEINDEXPATH}/dmel_intron intron
bowtieout2mapper.pl $inserts.intron /home/ww74w/smallRNApipeline/pipeline_dm/common/intron.map > $inserts.intron.mapper
...
run_bowtie.pl $inserts.uniq.reads $mm ${BOWTIEINDEXPATH}/dmel_intergenic intergenic
bowtieout2mapper.pl $inserts.intergenic /home/ww74w/smallRNApipeline/pipeline_dm/common/intergenic.map > $inserts.intergenic.mapper
...
echo `date` >> $dir/output/$insertsname.log
paraFile=$dir/output/${RANDOM}.para
echo -ne "normbed2mapper /home/ww74w/smallRNApipeline/pipeline_dm/common/cisNAT.map  $inserts.xkxh.norm.bed  map  >  $inserts.xkxh.norm.bed.cisNAT &&" >>${paraFile}
echo -e "lenselector $inserts.xkxh.norm.bed.cisNAT 21 >  $inserts.xkxh.norm.bed.cisNAT.seq.21nt" >>${paraFile}
echo -ne "normbed2mapper /home/ww74w/smallRNApipeline/pipeline_dm/common/structured_loci.map  $inserts.xkxh.norm.bed  map  > $inserts.xkxh.norm.bed.structured_loci &&" >>${paraFile} 
echo -e "lenselector $inserts.xkxh.norm.bed.transposons 21 > $inserts.xkxh.norm.bed.transposons.seq.21nt" >>${paraFile}
echo -ne "normbed2mapper /home/ww74w/smallRNApipeline/pipeline_dm/common/transposons.map $inserts.xkxh.norm.bed map > $inserts.xkxh.norm.bed.transposons &&" >>${paraFile}
...
echo -e "RRR /home/ww74w/smallRNApipeline/pipeline_dm/R.source plot_lendis $inserts.match2_all.out.uniq.lendis ">>${paraFile}

echo -ne "lendis $inserts.match2_all.out.uniq.reads r > $inserts.match2_all.out.reads.lendis && ">>${paraFile}
echo -e "RRR /home/ww74w/smallRNApipeline/pipeline_dm/R.source plot_lendis $inserts.match2_all.out.reads.lendis ">>${paraFile}

echo -ne "lendis $inserts.xk.match2_all.out.uniq.reads > $inserts.xk.match2_all.out.uniq.lendis && ">>${paraFile}
echo -e "RRR /home/ww74w/smallRNApipeline/pipeline_dm/R.source plot_lendis $inserts.xk.match2_all.out.uniq.lendis ">>${paraFile}

echo -ne "lendis $inserts.xk.match2_all.out.uniq.reads r > $inserts.xk.match2_all.out.reads.lendis && ">>${paraFile}
echo -e "RRR /home/ww74w/smallRNApipeline/pipeline_dm/R.source plot_lendis $inserts.xk.match2_all.out.reads.lendis ">>${paraFile}

echo -ne "lendis $inserts.xkxh.match2_all.out.uniq.reads > $inserts.xkxh.match2_all.out.uniq.lendis && ">>${paraFile}
echo -e "RRR /home/ww74w/smallRNApipeline/pipeline_dm/R.source plot_lendis $inserts.xkxh.match2_all.out.uniq.lendis ">>${paraFile}

echo -ne "lendis $inserts.xkxh.match2_all.out.uniq.reads r > $inserts.xkxh.match2_all.out.reads.lendis && ">>${paraFile}
echo -e "RRR /home/ww74w/smallRNApipeline/pipeline_dm/R.source plot_lendis $inserts.xkxh.match2_all.out.reads.lendis ">>${paraFile}

echo -e "lendis2.pl $inserts.xkxh.transposon.mapper2 > $inserts.xkxh.transposon.mapper2.lendis2 &&">>${paraFile}
echo -e "RRR /home/ww74w/smallRNApipeline/pipeline_dm/R.source plot_lendis2 $inserts.xkxh.transposon.mapper2.lendis2 ">>${paraFile}
...
#mail -s "Your job_$ID has completed" $EMAIL < /home/ww74w/smallRNApipeline/pipeline_dm/common/job_complete_message
