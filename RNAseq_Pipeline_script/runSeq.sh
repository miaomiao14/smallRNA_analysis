...
# script search PATH
export PATH=${DEG_PIPELINE_ADD}/bin:${PATH}
#
#bamToBed2=/diag/home/pkulance/softwares/modified_tools/bedtools-2.17.0/bin/bamToBed2
bamToBed2='/diag/home/netashawang/src/modified_tools/bedtools-2.17.0/bin/bedtools bamtobed'
#########
# USAGE #
#########
usage() {
